...
#define CAMERA_INDEX    11      //"/dev/video11"
...
void *videoCapture_thread(void *para)
{
    ...
    if(pPara){
        ...
        mipicamera_set_format(CAMERA_INDEX, RK_FORMAT_YCbCr_420_SP);
        ...
        wp.out_fps = 25;  //此变量仅用作设置SPS内的帧率信息，实际帧率由commit_buffer_to_encMedia_channel的频率决定
